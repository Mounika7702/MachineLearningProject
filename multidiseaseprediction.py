...
# Load models
diabetes_model = joblib.load('Project-Multidisease/catboost_diabetes_pipeline.pkl')
heart_disease_model = joblib.load("Project-Multidisease/catboost_heart_pipeline.pkl")
parkinsons_model = joblib.load('Project-Multidisease/catboost_parkinson_pipeline.pkl')
